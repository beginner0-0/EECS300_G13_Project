...
std::optional<StateMachine::Event> inputToEvent(bool iinput1, bool iinput2, bool iinput3, bool iinput4, bool iinput5) {
    if (iinput1) {
...
int main() {
    ...
    while (true) {
        ...
        usleep(1000);
        auto event = inputToEvent(input1, input2, input3, input4, input5);
